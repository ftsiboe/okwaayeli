...
study_setup <- function(
    ...
    local_directories = list(
      ...
      data             = file.path("studies", project_name, "data"),
      output           = file.path("studies", project_name, "output"),
      matching         = file.path("studies", project_name, "output", "matching"),
      treatment_effects= file.path("studies", project_name, "output", "treatment_effects"),
      estimations      = file.path("studies", project_name, "output", "estimations"),
      figure_data      = file.path("studies", project_name, "output", "figure_data"),
      figure           = file.path("studies", project_name, "output", "figure")
    )
){
