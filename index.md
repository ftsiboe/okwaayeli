...
- [Overview](#id_-overview)
- [At a glance](#id_-at-a-glance)
- [Data](#id_-data)
- [Methods](#id_-methods)
- [Pipeline](#id_-pipeline)
- [Published studies](#id_-published-studies)
- [Work in progress](#id_-work-in-progress)
- [Scheduled studies](#id_-scheduled-studies)
- [Installation](#id_-installation)
- [Quick start](#id_-quick-start)
- [Contributing](#id_-contributing)
- [Citation](#id_-citation)
- [Data and code availability](#id_-data-and-code-availability)
- [Contact](#id_-contact)
- [Funding](#id_-funding)
...
[data-raw/releases/harmonized_data/codebook.md](https://ftsiboe.github.io/okwaayeli/data-raw/releases/harmonized_data/codebook.md)
...
vignette](https://ftsiboe.github.io/okwaayeli/vignettes/msf-and-matching.Rmd).
...
Please read
[CONTRIBUTING.md](https://ftsiboe.github.io/okwaayeli/CONTRIBUTING.md)
for the standard study pipeline, the “how to add a new study” template,
and the coding conventions. New issues, study proposals and data
requests have dedicated [issue
templates](https://ftsiboe.github.io/okwaayeli/.github/ISSUE_TEMPLATE/).
Methodology questions are best asked under
[Discussions](https://github.com/ftsiboe/okwaayeli/discussions).

This project follows the [Contributor
Covenant](https://ftsiboe.github.io/okwaayeli/code_of_conduct.md).
...
full list is in [Published studies](#id_-published-studies).
...
See the [LICENSE](https://ftsiboe.github.io/okwaayeli/LICENSE) file in
the repository’s root for details.
