...
# A LIBRARY, not a step: sourced by the Rmd at knit time (and by 102, when it
# exists). It resolves its own paths via .STUDY_ROOT. See scripts/README.md.
...
# not rely on article_helpers.R's repo-root-relative paths.
