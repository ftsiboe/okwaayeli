...
compress
saveold "$GitHub\labs\GHAgricProductivityLab\studies\disability\output\disability_study_data",replace ver(12)


use "$GitHub\labs\GHAgricProductivityLab\studies\disability\output\disability_study_data",clear
...
*/ using "$GitHub\labs\GHAgricProductivityLab\studies\disability\output\disability_results.xlsx", /*
