...
# wd inside the .rds is a SNAPSHOT taken when the environment was last written.
# Recompute it, or this stage writes to whatever layout was current then --
# silently, and into folders that no longer exist. See ?study_dirs.
