...
compress
saveold "$GitHub\ghana\okwaayeli\studies\ag_services\data\tech_inefficiency_ag_services_data",replace ver(12)

use "$GitHub\ghana\okwaayeli\studies\ag_services\data\tech_inefficiency_ag_services_data",clear
tab Surveyx
...
/*
* REMOVED 2026-08-07: leftover from the Farmer-Age-Productivity study. The bare relative
* path "Results\" does not exist in this repo, so this wrote outside the tree or failed.
...
*/ using "$GitHub\ghana\okwaayeli\studies\ag_services\output\tables\ag_services_results-summary-statistics.xlsx", /*
