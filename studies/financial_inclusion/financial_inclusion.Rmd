...
builds the financial inclusion index — a *covariate*, not the treatment — and
writes it as a harmonized release that `001` reads back. The treatment is
`credit_hh`; see the README section on the treatment variable.
