...
#
# Upstream of all of this and NOT a stage here:
#   scripts/000_INDEX_financial_inclusion_study.do (Stata) builds the financial
#   inclusion index -- the variable this study is named for -- and writes it to
#   data-raw/releases/harmonized_data/. 001 reads it back. Rerun it by hand in
#   Stata when the index definition changes. See
