...
compress
saveold "$GitHub\ghana\okwaayeli\replications\resource_extraction\output\tech_inefficiency_resource_extract_data",replace ver(12)



use "$GitHub\ghana\okwaayeli\replications\resource_extraction\output\tech_inefficiency_resource_extract_data",clear
tab Surveyx
...
*/ using "$GitHub\ghana\okwaayeli\replications\resource_extraction\output\resource_extraction_results.xlsx", /*
